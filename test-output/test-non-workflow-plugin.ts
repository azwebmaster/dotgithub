...
/**
 * Plugin generated from action.yml
 * 
 * This plugin was auto-generated from .github files.
 * Files included: workflows/action.yml
 */
export class TestNonWorkflowPlugin implements DotGitHubPlugin {
  readonly name = 'test-non-workflow';
  readonly version = '1.0.0';
  readonly description = 'Plugin generated from action.yml';
  ...
  async applyWorkflows(context: PluginContext): Promise<void> {
    ...
    stack.addWorkflow('action', this.workflows['action']);
  }
...
export default new TestNonWorkflowPlugin();
