...
export class Checkout extends GitHubAction<CheckoutInputs, CheckoutOutputsType> {
  protected uses = "actions/checkout";
  protected fallbackRef = "08c6903cd8c0fde910a37f88322edcfb5dd907a8";
  protected outputs = CheckoutOutputs;
