...
Available Options:
 ...
 | default: "warn" */
  "if-no-files-found"?: GitHubActionInputValue;
 ...
 */
 ...
 | default: "false" */
  overwrite?: GitHubActionInputValue;
  /** If true, hidden files will be included in the artifact. If false, hidden files will be excluded from the artifact.
 | default: "false" */
  "include-hidden-files"?: GitHubActionInputValue;
};
export type UploadABuildArtifactOutputs = {
...
*/
export function uploadABuildArtifact(
  inputs: UploadABuildArtifactInputs,
  step?: Partial<GitHubStepBase>,
  ref?: string,
): GitHubStep<UploadABuildArtifactInputs> {
  return createStep(
