 ...
 *
 * @see {@link https://github.com/actions/checkout/tree/v6} - GitHub repository and documentation
 */
export class Checkout extends ActionConstruct<
  CheckoutInputs,
  CheckoutOutputsType
> {
  protected readonly uses = "actions/checkout";
  protected readonly fallbackRef = "de0fac2e4500dabe0009e67214ff5f5447ce83dd";
